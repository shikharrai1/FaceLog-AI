...
//       setError("Only ZIP files are supported. Please upload a .zip folder.");
//       setResult(null);
//       return;
//     }
...
//       <div>
//         <h2 className="text-xl font-semibold">Enroll Image Folder</h2>
//         <p className="text-sm text-gray-400 mt-1">
//           Upload a <strong>.zip</strong> file containing JPG / JPEG / PNG images only.
//         </p>
//       </div>
...
//       {loading && (
//         <p className="text-yellow-400">Processing ZIP file…</p>
//       )}
...
//       {/* ✅ Delegate rendering to EnrollmentResults */}
